...
var CustomNodeModel = /*#__PURE__*/function (_DefaultNodeModel) {
  _inherits(CustomNodeModel, _DefaultNodeModel);

  var _super = _createSuper(CustomNodeModel);

  function CustomNodeModel(props) {
  ...
  _createClass(CustomNodeModel, [{
    ...
    value: function serialize() {
      return _objectSpread({}, _get(_getPrototypeOf(CustomNodeModel.prototype), "serialize", this).call(this));
    }
  }, {
    key: "deserialize",
    value: function deserialize(event, engine) {
      _get(_getPrototypeOf(CustomNodeModel.prototype), "deserialize", this).call(this, event, engine);
    }
  }]);

  return CustomNodeModel;
}(_reactDiagrams.DefaultNodeModel);
